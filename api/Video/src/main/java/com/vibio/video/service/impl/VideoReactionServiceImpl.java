...
public class VideoReactionServiceImpl implements VideoReactionService {
    ...
    private void unLikeVideo(String videoId, String accountId) {
        videoReactionRepository
                .findByVideoIdAndUserIdAndReactionType(videoId, accountId, ReactionType.LIKE).ifPresent(videoReactionRepository::delete);
    ...
    private void unDislikeVideo(String videoId, String accountId) {
        videoReactionRepository
                .findByVideoIdAndUserIdAndReactionType(videoId, accountId, ReactionType.DISLIKE).ifPresent(videoReactionRepository::delete);
